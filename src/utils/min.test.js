...
describe('utils/min', () => {
  ...
  it('should return the smallest element when multiple positive integers', () => {
    expect(min([1, 3, 7, 4, 2])).toEqual(1);
    expect(min([1, 3, 7, 4, 2, 9, 10, 4])).toEqual(1);
  });

  it('should return the smallest element when multiple negative integers', () => {
    expect(min([-1, -3, -7, -4, -2])).toEqual(-7);
    expect(min([-1, -3, -7, -4, -2, -9, -10, -4])).toEqual(-10);
  });

  it('should return the smallest element when both positive and negative intergers', () => {
    expect(min([1, -1, 2, -7])).toEqual(-7);
    expect(min([-1, 3, 7, -4, 2, -9, -10, 4])).toEqual(-10);
  });

  it('should return the smallest element when both positive and negative floating numbers', () => {

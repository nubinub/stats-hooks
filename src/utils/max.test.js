...
describe('utils/max', () => {
  ...
  it('should return the greater element when multiple positive integers', () => {
    expect(max([1, 3, 7, 4, 2])).toEqual(7);
    expect(max([1, 3, 7, 4, 2, 9, 10, 4])).toEqual(10);
  });

  it('should return the greater element when multiple negative integers', () => {
    expect(max([-1, -3, -7, -4, -2])).toEqual(-1);
    expect(max([-1, -3, -7, -4, -2, -9, -10, -4])).toEqual(-1);
  });

  it('should return the greater element when both positive and negative intergers', () => {
    expect(max([1, -1, 2, -7])).toEqual(2);
    expect(max([-1, 3, 7, -4, 2, -9, -10, 4])).toEqual(7);
  });

  it('should return the greater element when both positive and negative floating numbers', () => {
